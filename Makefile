...
# package with it.
BUILD_DIR := obj
SOURCES := iptv_core.c iptv_playlist.c iptv_log.c iptv_osd.c iptv_text.c iptv_zap.c iptv_drift.c iptv_epg.c iptv_sequence.c iptv_ytdlp.c vlc_video.c vlc_audio.c vlc_dynamic.c
